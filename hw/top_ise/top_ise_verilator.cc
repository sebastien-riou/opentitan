...
int main(int argc, char **argv) {
  ...
  memutil.RegisterMemoryArea(
      "rom",
      "TOP.top_ise_verilator.top_ise.u_rom_rom.u_prim_rom."
      "gen_generic.u_impl_generic");
  memutil.RegisterMemoryArea(
      "ram",
      "TOP.top_ise_verilator.top_ise.u_ram1p_ram_main.u_mem."
      "gen_generic.u_impl_generic");
  memutil.RegisterMemoryArea(
      "flash",
      ("TOP.top_ise_verilator.top_ise.u_flash_eflash."
