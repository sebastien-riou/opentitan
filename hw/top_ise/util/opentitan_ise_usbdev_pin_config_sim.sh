...
VERILATOR=build/lowrisc_systems_top_ise_verilator_0.1/sim-verilator/Vtop_ise_verilator
...
# Expected output
EXPECT_USB=hw/top_ise/util/opentitan_ise_usbdev_expected-usb.log
EXPECT_UART=hw/top_ise/util/opentitan_ise_usbdev_expected-uart.log
