...
orighdr = hdr + '''
// This file has been automatically created from top_ise.hjson.
// This is a reformatted copy of top_ise.hjson
'''

genhdr = hdr + '''
// This file has been automatically modified to reduce the size of the flash.
// To see what has been changed, please compare to top_ise.original.hjson.
'''
...
def main():
    ...
    top_hjson = top_path + "/hw/top_ise/data/top_ise.hjson"
    ...
    with open(top_path + "/hw/top_ise/data/top_ise.original.hjson", "w") as hjson_file:
