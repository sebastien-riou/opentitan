...
module top_ise #(
  ...
  tlul_pkg::tl_h2d_t       ise_tl_req;
  tlul_pkg::tl_d2h_t       ise_tl_rsp;
  tlul_pkg::tl_h2d_t       ipc_tl_req;
  tlul_pkg::tl_d2h_t       ipc_tl_rsp;
