...
initial begin
  ...
  if (xbar_mode) begin
    ...
    $assertoff(0, tb);
    $asserton(0, tb.dut.top_ise.u_xbar_main);
    $asserton(0, tb.dut.top_ise.u_xbar_peri);
    ...
    force tb.dut.top_ise.u_xbar_main.clk_main_i = clk_main;
    force tb.dut.top_ise.u_xbar_main.clk_fixed_i = clk_io_div4;
    force tb.dut.top_ise.u_xbar_peri.clk_peri_i = clk_io_div4;

    // bypass rstmgr, force resets directly
    force tb.dut.top_ise.u_xbar_main.rst_main_ni = rst_n;
    force tb.dut.top_ise.u_xbar_main.rst_fixed_ni = rst_n;
    force tb.dut.top_ise.u_xbar_peri.rst_peri_ni = rst_n;
