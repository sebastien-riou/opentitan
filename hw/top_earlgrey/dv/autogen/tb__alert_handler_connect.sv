...
assign alert_if[0].alert_tx = `CHIP_HIER.u_sensor_ctrl.alert_tx_o[0];
assign alert_if[1].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[0];
assign alert_if[2].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[1];
