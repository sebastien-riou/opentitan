...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_ipc_o,
  input  tlul_pkg::tl_d2h_t tl_ipc_i,
  ...
  tl_h2d_t tl_s1n_31_ds_h2d [11];
  tl_d2h_t tl_s1n_31_ds_d2h [11];
  ...
  assign tl_sm1_23_us_h2d[1] = tl_s1n_31_ds_h2d[3];
  assign tl_s1n_31_ds_d2h[3] = tl_sm1_23_us_d2h[1];

  assign tl_sm1_24_us_h2d[1] = tl_s1n_31_ds_h2d[4];
  assign tl_s1n_31_ds_d2h[4] = tl_sm1_24_us_d2h[1];
  ...
  assign tl_sm1_27_us_h2d[1] = tl_s1n_31_ds_h2d[7];
  assign tl_s1n_31_ds_d2h[7] = tl_sm1_27_us_d2h[1];

  assign tl_sm1_28_us_h2d[1] = tl_s1n_31_ds_h2d[8];
  assign tl_s1n_31_ds_d2h[8] = tl_sm1_28_us_d2h[1];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_31_ds_h2d[9];
  assign tl_s1n_31_ds_d2h[9] = tl_sm1_29_us_d2h[1];
  ...
  assign tl_ipc_o = tl_sm1_25_ds_h2d;
  assign tl_sm1_25_ds_d2h = tl_ipc_i;
  ...
  assign tl_padctrl_o = tl_sm1_28_ds_h2d;
  assign tl_sm1_28_ds_d2h = tl_padctrl_i;

  assign tl_alert_handler_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_alert_handler_i;

  assign tl_nmi_gen_o = tl_sm1_30_ds_h2d;
  assign tl_sm1_30_ds_d2h = tl_nmi_gen_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_21_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      ...
      ((tl_s1n_21_us_h2d.a_address <= (ADDR_MASK_PERI[5] + ADDR_SPACE_PERI[5])) &&
       (tl_s1n_21_us_h2d.a_address >= ADDR_SPACE_PERI[5])) ||
      ((tl_s1n_21_us_h2d.a_address <= (ADDR_MASK_PERI[6] + ADDR_SPACE_PERI[6])) &&
       (tl_s1n_21_us_h2d.a_address >= ADDR_SPACE_PERI[6]))
    ) begin
      dev_sel_s1n_21 = 4'd4;
    ...
    end else if ((tl_s1n_21_us_h2d.a_address & ~(ADDR_MASK_IPC)) == ADDR_SPACE_IPC) begin
      dev_sel_s1n_21 = 4'd6;
  ...
  always_comb begin
    ...
    if ((tl_s1n_31_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      ...
      ((tl_s1n_31_us_h2d.a_address <= (ADDR_MASK_PERI[1] + ADDR_SPACE_PERI[1])) &&
       (tl_s1n_31_us_h2d.a_address >= ADDR_SPACE_PERI[1])) ||
      ((tl_s1n_31_us_h2d.a_address <= (ADDR_MASK_PERI[2] + ADDR_SPACE_PERI[2])) &&
       (tl_s1n_31_us_h2d.a_address >= ADDR_SPACE_PERI[2])) ||
      ((tl_s1n_31_us_h2d.a_address <= (ADDR_MASK_PERI[3] + ADDR_SPACE_PERI[3])) &&
       (tl_s1n_31_us_h2d.a_address >= ADDR_SPACE_PERI[3])) ||
      ((tl_s1n_31_us_h2d.a_address <= (ADDR_MASK_PERI[4] + ADDR_SPACE_PERI[4])) &&
       (tl_s1n_31_us_h2d.a_address >= ADDR_SPACE_PERI[4])) ||
      ((tl_s1n_31_us_h2d.a_address <= (ADDR_MASK_PERI[5] + ADDR_SPACE_PERI[5])) &&
       (tl_s1n_31_us_h2d.a_address >= ADDR_SPACE_PERI[5])) ||
      ((tl_s1n_31_us_h2d.a_address <= (ADDR_MASK_PERI[6] + ADDR_SPACE_PERI[6])) &&
       (tl_s1n_31_us_h2d.a_address >= ADDR_SPACE_PERI[6]))
    ) begin
      dev_sel_s1n_31 = 4'd3;
    ...
    end else if ((tl_s1n_31_us_h2d.a_address & ~(ADDR_MASK_IPC)) == ADDR_SPACE_IPC) begin
      dev_sel_s1n_31 = 4'd5;
    ...
    end else if ((tl_s1n_31_us_h2d.a_address & ~(ADDR_MASK_PADCTRL)) == ADDR_SPACE_PADCTRL) begin
      dev_sel_s1n_31 = 4'd8;

    end else if ((tl_s1n_31_us_h2d.a_address & ~(ADDR_MASK_ALERT_HANDLER)) == ADDR_SPACE_ALERT_HANDLER) begin
      dev_sel_s1n_31 = 4'd9;

    end else if ((tl_s1n_31_us_h2d.a_address & ~(ADDR_MASK_NMI_GEN)) == ADDR_SPACE_NMI_GEN) begin
  ...
  tlul_socket_1n #(
    ...
    .DReqPass  (13'hfff),
    .DRspPass  (13'hfff),
    .DReqDepth (52'h2000000000000),
    .DRspDepth (52'h2000000000000),
    .N         (13)
  ) u_s1n_21 (
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
