...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_aes2_o,
  input  tlul_pkg::tl_d2h_t tl_aes2_i,
  ...
  assign tl_sm1_37_us_h2d[0] = tl_s1n_25_ds_h2d[14];
  assign tl_s1n_25_ds_d2h[14] = tl_sm1_37_us_d2h[0];

  assign tl_keymgr_o = tl_s1n_25_ds_h2d[15];
  assign tl_s1n_25_ds_d2h[15] = tl_keymgr_i;
  ...
  assign tl_aes2_o = tl_sm1_30_ds_h2d;
  assign tl_sm1_30_ds_d2h = tl_aes2_i;

  assign tl_hmac_o = tl_sm1_31_ds_h2d;
  assign tl_sm1_31_ds_d2h = tl_hmac_i;

  assign tl_rv_plic_o = tl_sm1_32_ds_h2d;
  assign tl_sm1_32_ds_d2h = tl_rv_plic_i;

  assign tl_pinmux_o = tl_sm1_33_ds_h2d;
  assign tl_sm1_33_ds_d2h = tl_pinmux_i;

  assign tl_padctrl_o = tl_sm1_34_ds_h2d;
  assign tl_sm1_34_ds_d2h = tl_padctrl_i;

  assign tl_alert_handler_o = tl_sm1_35_ds_h2d;
  assign tl_sm1_35_ds_d2h = tl_alert_handler_i;

  assign tl_nmi_gen_o = tl_sm1_36_ds_h2d;
  assign tl_sm1_36_ds_d2h = tl_nmi_gen_i;

  assign tl_otbn_o = tl_sm1_37_ds_h2d;
  assign tl_sm1_37_ds_d2h = tl_otbn_i;

  assign tl_kmac_o = tl_sm1_38_ds_h2d;
  assign tl_sm1_38_ds_d2h = tl_kmac_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_25_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      ...
      ((tl_s1n_25_us_h2d.a_address <= (ADDR_MASK_PERI[2] + ADDR_SPACE_PERI[2])) &&
       (tl_s1n_25_us_h2d.a_address >= ADDR_SPACE_PERI[2])) ||
      ((tl_s1n_25_us_h2d.a_address <= (ADDR_MASK_PERI[3] + ADDR_SPACE_PERI[3])) &&
       (tl_s1n_25_us_h2d.a_address >= ADDR_SPACE_PERI[3])) ||
      ((tl_s1n_25_us_h2d.a_address <= (ADDR_MASK_PERI[4] + ADDR_SPACE_PERI[4])) &&
       (tl_s1n_25_us_h2d.a_address >= ADDR_SPACE_PERI[4])) ||
      ((tl_s1n_25_us_h2d.a_address <= (ADDR_MASK_PERI[5] + ADDR_SPACE_PERI[5])) &&
       (tl_s1n_25_us_h2d.a_address >= ADDR_SPACE_PERI[5])) ||
      ((tl_s1n_25_us_h2d.a_address <= (ADDR_MASK_PERI[6] + ADDR_SPACE_PERI[6])) &&
       (tl_s1n_25_us_h2d.a_address >= ADDR_SPACE_PERI[6]))
    ) begin
      dev_sel_s1n_25 = 5'd4;
    ...
    end else if ((tl_s1n_25_us_h2d.a_address & ~(ADDR_MASK_AES2)) == ADDR_SPACE_AES2) begin
      dev_sel_s1n_25 = 5'd7;
    ...
    end else if ((tl_s1n_25_us_h2d.a_address & ~(ADDR_MASK_PINMUX)) == ADDR_SPACE_PINMUX) begin
      dev_sel_s1n_25 = 5'd10;

    end else if ((tl_s1n_25_us_h2d.a_address & ~(ADDR_MASK_PADCTRL)) == ADDR_SPACE_PADCTRL) begin
  ...
  always_comb begin
    ...
    if ((tl_s1n_39_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      ...
      ((tl_s1n_39_us_h2d.a_address <= (ADDR_MASK_PERI[1] + ADDR_SPACE_PERI[1])) &&
       (tl_s1n_39_us_h2d.a_address >= ADDR_SPACE_PERI[1])) ||
      ((tl_s1n_39_us_h2d.a_address <= (ADDR_MASK_PERI[2] + ADDR_SPACE_PERI[2])) &&
       (tl_s1n_39_us_h2d.a_address >= ADDR_SPACE_PERI[2])) ||
      ((tl_s1n_39_us_h2d.a_address <= (ADDR_MASK_PERI[3] + ADDR_SPACE_PERI[3])) &&
       (tl_s1n_39_us_h2d.a_address >= ADDR_SPACE_PERI[3])) ||
      ((tl_s1n_39_us_h2d.a_address <= (ADDR_MASK_PERI[4] + ADDR_SPACE_PERI[4])) &&
       (tl_s1n_39_us_h2d.a_address >= ADDR_SPACE_PERI[4])) ||
      ((tl_s1n_39_us_h2d.a_address <= (ADDR_MASK_PERI[5] + ADDR_SPACE_PERI[5])) &&
       (tl_s1n_39_us_h2d.a_address >= ADDR_SPACE_PERI[5])) ||
      ((tl_s1n_39_us_h2d.a_address <= (ADDR_MASK_PERI[6] + ADDR_SPACE_PERI[6])) &&
       (tl_s1n_39_us_h2d.a_address >= ADDR_SPACE_PERI[6]))
    ) begin
      dev_sel_s1n_39 = 4'd3;
    ...
    end else if ((tl_s1n_39_us_h2d.a_address & ~(ADDR_MASK_AES2)) == ADDR_SPACE_AES2) begin
      dev_sel_s1n_39 = 4'd6;
    ...
    end else if ((tl_s1n_39_us_h2d.a_address & ~(ADDR_MASK_PADCTRL)) == ADDR_SPACE_PADCTRL) begin
  ...
  tlul_socket_1n #(
    ...
    .DReqPass  (17'h17fff),
    .DRspPass  (17'h17fff),
    .DReqDepth (68'h2000000000000000),
    .DRspDepth (68'h2000000000000000),
    .N         (17)
  ) u_s1n_25 (
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
