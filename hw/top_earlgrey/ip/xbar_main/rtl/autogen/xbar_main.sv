...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_ise_o,
  input  tlul_pkg::tl_d2h_t tl_ise_i,
  ...
  assign tl_sm1_36_us_h2d[0] = tl_s1n_24_ds_h2d[14];
  assign tl_s1n_24_ds_d2h[14] = tl_sm1_36_us_d2h[0];

  assign tl_keymgr_o = tl_s1n_24_ds_h2d[15];
  assign tl_s1n_24_ds_d2h[15] = tl_keymgr_i;
  ...
  assign tl_ise_o = tl_sm1_28_ds_h2d;
  assign tl_sm1_28_ds_d2h = tl_ise_i;

  assign tl_ipc_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_ipc_i;
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_24_us_h2d.a_address & ~(ADDR_MASK_ISE)) == ADDR_SPACE_ISE) begin
      dev_sel_s1n_24 = 5'd6;

    end else if ((tl_s1n_24_us_h2d.a_address & ~(ADDR_MASK_IPC)) == ADDR_SPACE_IPC) begin
      dev_sel_s1n_24 = 5'd7;
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_37_us_h2d.a_address & ~(ADDR_MASK_ISE)) == ADDR_SPACE_ISE) begin
      dev_sel_s1n_37 = 4'd5;

    end else if ((tl_s1n_37_us_h2d.a_address & ~(ADDR_MASK_IPC)) == ADDR_SPACE_IPC) begin
      dev_sel_s1n_37 = 4'd6;
  ...
  tlul_socket_1n #(
    ...
    .DReqPass  (16'h7fff),
    .DRspPass  (16'h7fff),
    .DReqDepth (64'h2000000000000000),
    .DRspDepth (64'h2000000000000000),
    .N         (16)
  ) u_s1n_24 (
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
